...
public class HTTrackerSweatingGraphView extends AbstractTrackerGraphViewLine<HTTrackerSweating>
{
	public HTTrackerSweatingGraphView(Context context)
	{
		super(context);
	}
	...
	protected List<GraphValuePointsDataSet> getGraphValuePointDataSets()
	{
		...
		for (HTTrackerSweating tracker: trackerEntriesGlobal) {
		...
		GraphValuePointsDataSet ds = new GraphValuePointsDataSet(); ds.graphValuePoints = gpvs; ds.dataSetLabel = "sweating"; ds.dataSetColor = 0xFFF00000;
