...
public class YAxisRenderer extends AxisRenderer {
	...
	protected void computeAxisValues(float min, float max) {
		...
		if (mYAxis.isForceLabelsEnabled()) {
            ...
            float step = calculateStep((float) range);
    ...
    public static float calculateStep(float valuerange){
		float step = 1;
		if (valuerange < 11 ) {
			step = 1;
		} else if  (valuerange < 21 ) {
			step = 2;
		} else if  (valuerange < 51 ) {
			step = 5;
		} else if  (valuerange < 101 ) {
			step = 10;
		} else if  (valuerange < 201 ) {
			step = 20;
		} else if  (valuerange < 501 ) {
			step = 50;
		} else if  (valuerange < 1001 ) {
			step = 100;
		} else if  (valuerange < 2001 ) {
			step = 200;
		} else if  (valuerange < 5001 ) {
			step = 500;
		} else {
			step = 1000;
		}
